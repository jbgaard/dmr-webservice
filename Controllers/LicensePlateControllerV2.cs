...
namespace DMRWebScrapper_service.Controllers
{
    [ApiController]
    [Route("api/v2")]
    public class LicensePlateControllerV2 : ControllerBase
    {

        // Logger
        private readonly ILogger<LicensePlateControllerV2> _logger;
        ...
        public LicensePlateControllerV2(ILogger<LicensePlateControllerV2> logger, DMRProxy proxy, VehicleViewService vehicleViewService, PoliceReportService policeReportService)
        {
            _logger = logger;
            _proxy = proxy;
